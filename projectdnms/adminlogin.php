            ...
            <div class="modal-body p-4 pt-0">
                <form  action="admin_login_check.php" method="POST" class="login_form">
                    <div class="form-floating mb-3 ">
                        <input type="email" class="form-control rounded-3 mb-3 " placeholder="shrye@shd.com"  id="floaintInput" name="email">
                        <label for="floaintInput">Email</label>
                    </div>
                    <div class="form-floating mb-3 ">
                    ...
                    <button class="but btn btn-primary lg rounded-3 w-100 mb-2" id="signupButton" > sign up  </button>
                    <hr>
